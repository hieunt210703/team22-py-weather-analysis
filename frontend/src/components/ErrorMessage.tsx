...
export const ErrorMessage: React.FC<ErrorMessageProps> = ({ locationName, onRetry, dataType = 'dữ liệu thời tiết' }) => {
  return (
    <div className="bg-card rounded-[24px] p-[32px] shadow-sh2 mt-[20px] text-center max-w-[540px] mx-auto border border-border">
      ...
      <h3 className="font-nunito font-semibold text-[18px] text-ink mb-[6px]">
        Không tải được {dataType}
      </h3>

      <p className="text-[14px] text-m2 leading-[1.6] mb-[20px]">
        Không tải được {dataType} cho <strong>{locationName}</strong>. Vui lòng kiểm tra kết nối mạng và thử lại.
      </p>
